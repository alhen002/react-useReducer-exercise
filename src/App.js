  ...
  switch (action.type) {
    ...
    case "deposit":
      return state.isActive
        ...
        : state;
    case "withdraw":
      return state.isActive ? { ...state, balance: state.balance - 50 } : state;
    case "requestLoan":
      return state.isActive
        ? state.loan === 0
          ? { ...state, loan: LOAN_SUM, balance: state.balance + LOAN_SUM }
          : state
        : state;
    case "payLoan":
      return state.isActive
        ? state.loan !== 0
          ? {
              ...state,
              loan: state.loan - LOAN_SUM,
              balance: state.balance - LOAN_SUM,
            }
          : state
        : state;
